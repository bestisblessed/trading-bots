...
export const apiSwap = async () => {
  ...
  const outputMint = 'EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm'
  const amount = 2_000_000; // This will swap 0.002 SOL
  const slippage = 5.0 // in percent, for this example, 0.5 means 0.5%
