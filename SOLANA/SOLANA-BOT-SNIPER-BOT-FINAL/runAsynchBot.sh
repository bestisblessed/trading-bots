...
screen -dmS $SESSION_NAME bash -c "export \$(grep -v '^#' .env | xargs); echo 'Using wallet: \$MY_BOT_WALLET_ADDRESS'; python check_wallet_and_log_buy_prices.py; node SCANNER-ASYNCHRONOUS.js; exec bash"
