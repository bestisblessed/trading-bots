...
// //         // Call the RugCheck detection function using the imported module
// //         await rugDetector(mintAddress);  // Call the function from rug.js

// //     } catch (error) {
// //         console.error(`Error fetching details for mint ${mintAddress}:`, error);
// //     }
// // }
// // //         // Fetch liquidity info before running rugDetector
// // //         const liquidityInfo = await getLiquidityInfo(mintAddress);

// // //         // Call the RugCheck detection function using Node.js
// // //         await rugDetector(mintAddress, liquidityInfo); 
...
// // // Fetch mint details, print to the console, and apply ranking logic
// // async function fetchAndPrintMintDetails(mintAddress) {
// //     try {
// //         const mintPublicKey = new PublicKey(mintAddress);
// //         const mintInfo = await getMint(connection, mintPublicKey);
...
// //         // Apply ranking logic for the specific token
// //         applyRanking(mintDetails);
...
//         // Write the mint details to the JSON file in the rug-detections directory
//         const filePath = path.join(rugDetectionsDir, `${mintDetails.mintAddress}.json`);
...
// function applyRanking(mintDetails) {
//     const tokenMintAddress = mintDetails.mintAddress;
//     const filePath = path.join(rugDetectionsDir, `${tokenMintAddress}.json`);
...
//         // };
//         const rankData = {
//             tokenMintAddress: tokenData.mintAddress, // Use mintAddress here
//             rank: rank
//         };
        
//         const outputFilePath = path.join('./rankings/', `${tokenData.mintAddress}_rank.json`); // Use mintAddress here        
//         // const outputFilePath = path.join('./rankings/', `${tokenData.tokenMintAddress}_rank.json`);
...
//         }
//     } else {
//         console.error(`File for ${tokenMintAddress} does not exist.`);
//     }
// }
...
function applyRanking(tokenData) {
    ...
    // // Save ranking with the correct tokenMintAddress as filename
